    ...
    def _seed_education_items(self):
        items = [
            ...
            },
            {
                ...
                "image_src": "/images/Education/course.png",
                "video_src": "",
                "title_ru": "Business tax planning",
                "title_bg": "Business tax planning",
                "description_ru": "Practical course for business owners who want cleaner tax planning.",
                "description_bg": "Practical course for business owners who want cleaner tax planning.",
                "start_date": parse_date("2026-05-18"),
                "price": "190",
                "level": EducationItem.LEVEL_BUSINESS,
                "goal": EducationItem.GOAL_OPTIMIZATION,
                "item_format": EducationItem.FORMAT_LIVE,
                "modules": [
                    ("Tax risk review", "How to identify common business tax risks."),
                    ("Planning workflow", "Steps for building a practical tax calendar."),
                ],
            },
            {
            ...
            {
                "item_type": EducationItem.TYPE_WEBINAR,
                "slug": "company-launch-checklist",
                "image_src": "/images/Education/webinar.png",
                "video_src": "",
                "title_ru": "Company launch checklist",
                "title_bg": "Company launch checklist",
                "description_ru": "Live session about the first tax and accounting steps after registration.",
                "description_bg": "Live session about the first tax and accounting steps after registration.",
                "start_date": parse_date("2026-06-09"),
                "price": "25",
                "level": EducationItem.LEVEL_BEGINNER,
                "goal": EducationItem.GOAL_LAUNCH,
                "item_format": EducationItem.FORMAT_ONLINE,
                "modules": [
                    ("First registrations", "What to prepare after opening a company."),
                    ("Accounting setup", "How to keep documents and reporting under control."),
                ],
            },
        ]
