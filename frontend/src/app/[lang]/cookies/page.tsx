  ...
  ru: {
    ...
    sections: [
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            ...
            ["Аналитические", "Помогают понимать посещаемость и улучшать структуру сайта. Используются только после согласия.", "Google Analytics 4, Measurement ID G-WN6PFNNWDN."],
      ...
      },
      {
        ...
        paragraphs: [
          "Сайт использует Google Analytics 4 только после вашего согласия в cookie-плашке. Мы используем эти данные в агрегированном виде, чтобы понимать посещаемость страниц и улучшать содержание сайта.",
          "Сайт не использует отдельные рекламные cookies для поведенческого таргетинга.",
        ],
      },
      {
  ...
  bg: {
    ...
    sections: [
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            ...
            ["Аналитични", "Помагат да разбираме посещаемостта и да подобряваме структурата на сайта. Използват се само след съгласие.", "Google Analytics 4, Measurement ID G-WN6PFNNWDN."],
      ...
      },
      {
        title: "3. Аналитика и маркетинг",
        paragraphs: [
          "Сайтът използва Google Analytics 4 само след вашето съгласие в плашката за бисквитки. Използваме тези данни в обобщен вид, за да разбираме посещаемостта на страниците и да подобряваме съдържанието на сайта.",
          "Сайтът не използва отделни рекламни бисквитки за поведенческо таргетиране.",
        ],
      },
      {
