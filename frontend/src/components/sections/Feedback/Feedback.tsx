...
export const Feedback = () => {
  ...
  const socialLinks = [
    {
      name: "Facebook",
      url: "https://www.facebook.com/bgbuhgalter/",
      icon: (
    ...
    {
      name: "LinkedIn",
      url: "https://www.linkedin.com/in/olena-shopova-7a5866246/",
      icon: (
        <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
          <circle cx="14" cy="14" r="14" fill="currentColor"/>
    ...
    {
      name: "YouTube",
      url: "https://www.youtube.com/@OlenaShopova",
      icon: (
        <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
          <circle cx="14" cy="14" r="14" fill="currentColor"/>
    ...
    {
      name: "Instagram",
      url: "https://www.instagram.com/olenashopova/",
      icon: (
        <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
          <circle cx="14" cy="14" r="14" fill="currentColor"/>
        ...
        <div className={styles.leftColumn}>
          ...
          <ul className={styles.contactList}>
            <li className={styles.contactItemWrapper}>
              <a
                href="https://t.me/buhgalter_v_bolgarii"
                target="_blank"
            ...
            <li className={styles.contactItemWrapper}>
              <a href={`tel:${t.phone1.replace(/\\s/g, '')}`} className={styles.contactItem}>
                <div className={styles.iconBox}>
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                </div>
                <span className={styles.contactText}>{t.phone1}</span>
              </a>
            </li>

            <li className={styles.contactItemWrapper}>
              <a href={`tel:${t.phone2.replace(/\\s/g, '')}`} className={styles.contactItem}>
                <div className={styles.iconBox}>
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                </div>
                <span className={styles.contactText}>{t.phone2}</span>
              </a>
            </li>
